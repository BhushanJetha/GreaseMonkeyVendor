...
public class MyProvidedManufacturerActivity extends BaseActivity implements IResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_provided_manufacturer);
    ...
    private void getManufacturer(){
        try {
            ...
            communicationChanel.communicateWithServer(MyProvidedManufacturerActivity.this,
    ...
    public void onRequestComplete(JSONObject jsonObject, String entity) {
        ...
        try {
            if(entity.equals("ManufacturerList")) {
                String response = jsonObject.getString("manufactures");
